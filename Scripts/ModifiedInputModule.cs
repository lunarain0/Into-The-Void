...
{
    [AddComponentMenu("Event/Modified Input Module")]
    public class ModifiedInputModule : PointerInputModule
    {
        ...
        /// </summary>
        [SerializeField]
        private string m_MenuVerticalAxis = "Vertical";

        /// <summary>
        /// Name of the submit button.
        /// </summary>
        [SerializeField]
        private string m_MenuSubmitButton = "Submit";
        ...
        /// </summary>
        [SerializeField]
        private string m_ActionVerticalAxis = "Vertical";

        /// <summary>
        /// Name of the submit button.
        /// </summary>
        [SerializeField]
        private string m_ActionSubmitButton = "Submit";
        ...
        public string VerticalAxis
        {
            get
            {
                if (m_InMenu)
                {
                    return m_MenuVerticalAxis;
                }
                else
                {
                    return m_ActionVerticalAxis;
                }
            }
        }
        ...
        public string SubmitButton
        {
            get
            {
                if (m_InMenu)
                {
                    return m_MenuSubmitButton;
                }
                else
                {
                    return m_ActionSubmitButton;
                }
            }
        }
        ...
        protected bool SendMoveEventToSelectedObject()
        {
            ...
            bool allow = input.GetButtonDown(VerticalAxis);
